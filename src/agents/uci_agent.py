...
class UCIAgent:
            ...
            for info in analysis:
                ...
                if 'score' in info:
                    ...
                    if score.is_mate():
                        ...
                        entry['score'] = 10000 - abs(mate_score) if mate_score > 0 else -10000 + abs(mate_score)
    ...
    def _get_limit(self, time_limit: Optional[float] = None) -> chess.engine.Limit:
