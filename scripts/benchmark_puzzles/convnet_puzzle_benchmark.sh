...
python3 scripts/benchmark_elo.py --backbone ${BACKBONE} --weights runs/${BACKBONE}_200M_e10/training/${BACKBONE}/best.pt --min-elo 800 --max-elo 2800 --step-elo 100 --puzzles-per-bracket 40
...
python3 scripts/benchmark_elo.py --backbone ${BACKBONE} --weights runs/${BACKBONE}_500M_e5/training/${BACKBONE}/best.pt --min-elo 800 --max-elo 2800 --step-elo 100 --puzzles-per-bracket 40
...
python3 scripts/benchmark_elo.py --backbone ${BACKBONE} --weights runs/${BACKBONE}_1000M_e1/training/${BACKBONE}/best.pt --min-elo 800 --max-elo 2800 --step-elo 100 --puzzles-per-bracket 40
